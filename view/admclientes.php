...
<body class="hold-transition sidebar-mini">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <button type="button" class="btn btn-primary" title="Nuevo cliente"  data-toggle="modal" data-target="#Insert"><i class="fa fa-street-view mr-2" aria-hidden="true"></i>Nuevo cliente</button>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr v-for="(clientes,indice) of ctClientes">
                                                <td class="text-center">{{clientes.intId_Persona}}</td>
                                                <td class="text-center">{{clientes.vchNombre}}</td>
                                                <td class="text-center">{{clientes.vchApPaterno}}</td>
                                                <td class="text-center">{{clientes.vchApMaterno}}</td>
                                                <td class="text-center">{{clientes.vchDireccion}}</td>
                                                <td class="text-center">{{clientes.vchTelefono}}</td>
                                                <td class="text-center">
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-success btn-sm" title="Editar cliente" data-toggle="modal" @click="cargarvalue(clientes.intId_Persona,clientes.vchNombre,clientes.vchApPaterno,clientes.vchApMaterno,clientes.vchDireccion,clientes.vchTelefono)" data-target="#Update" ><i class="fas fa-edit"></i></button>    
                                                        <button class="btn btn-danger btn-sm" title="Eliminar cliente" @click="eliminar(clientes.intId_Persona)"><i class="fas fa-trash"></i></button>       
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalLabel">Cliente</h5>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" title="Guardar" @click="insertar" data-dismiss="modal" aria-label="Close"><i class="fas fa-save"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../controller/conaclientes.js"></script>
    <script>
        $(function () {
            $("#example1").DataTable();
            $('#example2').DataTable({
