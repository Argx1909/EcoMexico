...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr v-for="(usuarios,indice) of ctUsuarios">
                                                ...
                                                <td class="text-center">{{usuarios.intId_Persona}}</td>
                                                ...
                                                <td class="text-center">{{usuarios.vchAcceso}}</td>
                                                <td class="text-center">
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-success btn-sm" title="Editar usuario" data-toggle="modal" @click="cargarvalue(usuarios.intId_Usuario,usuarios.intId_Persona,usuarios.vchEmail,usuarios.vchPassword,usuarios.intId_Rool,usuarios.vchAcceso)" data-target="#Update" ><i class="fas fa-edit"></i></button>    
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <select class="form-control" id="cmbInspersonas">
                                                    <option v-bind:value="0">Selecciona el propietario</option>
                                                    <option v-for="(personas,indice) of ctPersonas" v-bind:value="personas.intId_Persona">
                                                        {{personas.Nombre}}
                                                    </option> 
                                                </select>
                                            </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <select class="form-control" id="cmbInsacceso">
                                                    <option v-bind:value="0">Selecciona el acceso</option>
                            ...
                            <div class="modal-body">
                                <form enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <select class="form-control" id="cmbUpdpersonas">
                                                    <option v-bind:value="0">Selecciona el propietario</option>
                                                    <option v-for="(personas,indice) of ctPersonas" v-bind:value="personas.intId_Persona">
                                                        {{personas.Nombre}}
                                                    </option> 
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <select class="form-control" id="cmbUpdacceso">
                                                    <option v-bind:value="0">Selecciona el acceso</option>
                                                    <option>Concedido</option>
                                                    <option>Denegado</option>
                                                </select>
    ...
    <script src="../controller/conausuarios.js"></script>
    <script>
        $(function () {
            $("#example1").DataTable();
            $('#example2').DataTable({
