...
<body class="hold-transition sidebar-mini">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <button type="button" class="btn btn-primary" title="Nuevo proveedor"  data-toggle="modal" data-target="#Insert"><i class="fa fa-address-book mr-2" aria-hidden="true"></i>Nuevo proveedor</button>
                            </div>
                        </div>
                    </div>
                </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr v-for="(proveedores,indice) of ctProveedores">
                                                ...
                                                <td class="text-center">{{proveedores.vchApPaterno}}</td>
                                                <td class="text-center">{{proveedores.vchApMaterno}}</td>
                                                <td class="text-center">{{proveedores.vchEmail}}</td>
                                                <td class="text-center">{{proveedores.vchDireccion}}</td>
                                                <td class="text-center">{{proveedores.vchTelefono}}</td>
                                                <td class="text-center">
                                                    <div class="btn-group" role="group"> 
                                                        <button class="btn btn-success btn-sm" title="Editar proveedor" data-toggle="modal" @click="cargarvalue(proveedores.intId_Proveedor,proveedores.vchNombre,proveedores.vchApPaterno,proveedores.vchApMaterno,proveedores.vchEmail,proveedores.vchDireccion,proveedores.vchTelefono)" data-target="#Update" ><i class="fas fa-edit"></i></button>    
                                                        <button class="btn btn-danger btn-sm" title="Eliminar proveedor" @click="eliminar(proveedores.intId_Proveedor)"><i class="fas fa-trash"></i></button>       
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalLabel">Proveedores</h5>
                            ...
                            <div class="modal-body">
                                <form enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input id="txtInsdireccion" type="text" class="form-control" maxlength="50" placeholder="Direccion" onpaste="return false" />
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                            ...
                            <div class="modal-body">
                                <form enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input id="txtUpddireccion" type="text" class="form-control" maxlength="50" placeholder="Direccion" onpaste="return false" />
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
    ...
    <script src="../controller/conaproveedores.js"></script>
    <script>
        $(function () {
            $("#example1").DataTable();
            $('#example2').DataTable({
