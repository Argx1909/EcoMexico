...
$consulta="SELECT tblproductos.`intId_Producto`,tblproductos.`vchProducto`,tblproductos.`flPrecioVenta`,tblproductos.`vchImagen` FROM tblproductos,tblinventario WHERE tblinventario.`intCantAlmacen`>1 AND tblproductos.`intId_Producto`=tblinventario.`intId_Producto`;";
$resultado=$conexion->prepare($consulta);
$resultado->execute();
$contenido=$resultado->fetchAll(PDO::FETCH_ASSOC);
// CONSULTA A CATEGORIA MADERA
$consulta="SELECT tblproductos.`intId_Producto`,tblproductos.`vchProducto`,tblproductos.`flPrecioVenta`,tblproductos.`vchImagen` FROM tblproductos,tblinventario WHERE tblproductos.`intCategoria`=1 AND tblinventario.`intCantAlmacen`>1 AND tblproductos.`intId_Producto`=tblinventario.`intId_Producto`;";
$resultado=$conexion->prepare($consulta);
$resultado->execute();
$contenidoA=$resultado->fetchAll(PDO::FETCH_ASSOC);
// CONSULTA A CATEGORIA BORDADOS
$consulta="SELECT tblproductos.`intId_Producto`,tblproductos.`vchProducto`,tblproductos.`flPrecioVenta`,tblproductos.`vchImagen` FROM tblproductos,tblinventario WHERE tblproductos.`intCategoria`=2 AND tblinventario.`intCantAlmacen`>1 AND tblproductos.`intId_Producto`=tblinventario.`intId_Producto`;";
$resultado=$conexion->prepare($consulta);
$resultado->execute();
$contenidoB=$resultado->fetchAll(PDO::FETCH_ASSOC);
// CONSULTA A CATEGORIA BARRO
$consulta="SELECT tblproductos.`intId_Producto`,tblproductos.`vchProducto`,tblproductos.`flPrecioVenta`,tblproductos.`vchImagen` FROM tblproductos,tblinventario WHERE tblproductos.`intCategoria`=3 AND tblinventario.`intCantAlmacen`>1 AND tblproductos.`intId_Producto`=tblinventario.`intId_Producto`;";
$resultado=$conexion->prepare($consulta);
$resultado->execute();
$contenidoC=$resultado->fetchAll(PDO::FETCH_ASSOC);
// CONSULTA A CATEGORIA TEJIDOS
$consulta="SELECT tblproductos.`intId_Producto`,tblproductos.`vchProducto`,tblproductos.`flPrecioVenta`,tblproductos.`vchImagen` FROM tblproductos,tblinventario WHERE tblproductos.`intCategoria`=4 AND tblinventario.`intCantAlmacen`>1 AND tblproductos.`intId_Producto`=tblinventario.`intId_Producto`;";
$resultado=$conexion->prepare($consulta);
$resultado->execute();
$contenidoD=$resultado->fetchAll(PDO::FETCH_ASSOC);
?> 
<!DOCTYPE html>
<html>
    <head>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#Todos" data-toggle="tab"><i class="fa fa-bars"></i>&nbsp;&nbsp;Todas las categorías</a></li>
                            <li><a href="#CategoriaA" data-toggle="tab"><i class="fa fa-shopping-basket"></i>&nbsp;&nbsp;Artesanias de madera</a></li>
                            <li><a href="#CategoriaB" data-toggle="tab"><i class="fa fa-shopping-basket"></i>&nbsp;&nbsp;Artesanias con bordados</a></li>
                            <li><a href="#CategoriaC" data-toggle="tab"><i class="fa fa-shopping-basket"></i>&nbsp;&nbsp;Artesanias de barro</a></li>
                            <li><a href="#CategoriaD" data-toggle="tab"><i class="fa fa-shopping-basket"></i>&nbsp;&nbsp;Artesanias de tejido</a></li>
                        </ul>
                        <div class="tab-content">
                                ...
                                ?>
                                    <div class="col-sm-4">
                                        <div class="thumbnail text-center">
                                            <img class="img-thumbnail img-responsive" src="../src/img/productos/<?php echo $imagen;?>" alt="Image">
                                            <div class="caption">
                                                <h3 class="text-danger"><?php echo $producto;?></h3>
                                                <h4 class="text-dark">Precio:$<?php echo $precio;?></h4>
                                                <a href="vistadetalle.php?clave=<?=$dato['intId_Producto']?>" class="btn btn-info btn-sm">Más informacion</a></button>
                                            </div>
                                        </div>
                                    </div>
                                <?php }?>
                            </div>
                            <div class="tab-pane" id="CategoriaA">
                                <?php
                                foreach($contenidoA as $dato){
                                    $clave=$dato['intId_Producto'];
                                    $producto=$dato['vchProducto'];
                                    $precio=$dato['flPrecioVenta'];
                                    $imagen=$dato['vchImagen'];             
                            ...
                            <div class="tab-pane" id="CategoriaB">
                                <?php
                                foreach($contenidoB as $dato){
                                    $clave=$dato['intId_Producto'];
                                    $producto=$dato['vchProducto'];
                                    $precio=$dato['flPrecioVenta'];
                                    $imagen=$dato['vchImagen'];             
                            ...
                            <div class="tab-pane" id="CategoriaC">
                                <?php
                                foreach($contenidoC as $dato){
                                    $clave=$dato['intId_Producto'];
                                    $producto=$dato['vchProducto'];
                                    $precio=$dato['flPrecioVenta'];
                                    $imagen=$dato['vchImagen'];             
                            ...
                            <div class="tab-pane" id="CategoriaD">
                                <?php
                                foreach($contenidoD as $dato){
                                    $clave=$dato['intId_Producto'];
                                    $producto=$dato['vchProducto'];
                                    $precio=$dato['flPrecioVenta'];
                                    $imagen=$dato['vchImagen'];             
